...
MAINTAINER Michael Rüffer <lofd23@gmail.com>

ENV LANG C.UTF-8

# Packages
ENV MAIN_PACKAGES openssl git sqlite3 libsqlite3-dev curl
# ENV BUILD_DEPENDENCIES
# Gems to install
ENV DEFAULT_GEMS bundler rake rails apiaryio rubocop simplecov dredd_hooks nokogiri 
